...
.info-grid { background: #43cea2;  /* fallback for old browsers */
...
<div id="html-content-holder" >
    <div class="front-side">
        ...
        <div class="info-grid" style="background-image:url(images/8dab2ccfd0d3573d36a2764357b3d467.jpg);">
            <div class="name">
                <h2><?php echo $row['Company_contact_person_name']; ?></h2>
                <h5><?php echo $row['Company_contact_person_designation']; ?></h5>
<h5><?php echo $row['Company_contact_person_emailid']; ?></h5>
            </div>
            <div class="addr">
            ...
            <div class="phoneNo">
                ...
                <p>+91
                    <strong></strong> <?php echo $row['Company_contact_person_contact']; ?></p>
            </div>
            <div class="emailId">
                ...
                <p class="email"><?php echo $row['Company_contact_person_emailid']; ?></p>
                <p class="web">
                    <strong><?php echo $row['Company_website']; ?></strong>
                </p>
            </div>
        </div>
    </div>
    <div class="back-side"  
    style="background-image:url(images/8dab2ccfd0d3573d36a2764357b3d467.jpg);">
        <div class="color-grid">
            <div class="black"></div>
            <div class="red1"></div>
            <div class="red2"></div>
        ...
        <div class="name-tag">
             <h3><img src="images/logo/<?php echo $row['Company_logo']; ?>" style="height:90px; width:170px;"></h3> <h1>
                <strong><?php echo $row['Company_name']; ?></strong>
            </h1>
            <h3>Web: <?php echo $row['Company_website']; ?></h3>
              <h3>Services: <?php echo $row['Company_services']; ?></h3>
  ...
  <center>  <input id="btn-Preview-Image" type="button" value="Preview First Then Download"/>
    <a id="btn-Convert-Html2Image" href="#">Download</a>
     <a id="" href="design6.php?id=<?php echo $_GET['id']; ?>">Next Design</a>
    <br/>
    <h3>Preview :</h3>
    <div id="previewImage">
    </div>
