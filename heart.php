...
Maximum heart rate achieved
	 ...
	 <input type="text" name="achieved" id="fname" class="form-control" placeholder="Maximum heart rate achieved" required>
</div>
...
ST depression induced by exercise relative to rest
	 ...
	 <input type="text" name="depression" id="fname" class="form-control" placeholder="ST depression induced by exercise relative to rest" required>
</div>  
...
if($execute_query>0){
	echo "<script>alert('User Profile Successfully!!');</script>";	
	}else{
echo mysql_error();
	}
}
