...
<div id="html-content-holder" >
    <div class="front-side">
        ...
        <div class="info-grid" style="background-image:url(images/photo-1557683316-973673baf926.jpg);">
            <div class="name">
...
<h5><?php echo $row['Company_contact_person_emailid']; ?></h5>
    ...
    <div class="back-side"  
    style="background-image:url(images/photo-1557683316-973673baf926.jpg);">
        <div class="color-grid">
            <div class="black"></div>
            <div class="red1"></div>
            <div class="red2"></div>
        ...
        <div class="name-tag">
            ...
            <h3>Web: <?php echo $row['Company_website']; ?></h3>
              <h3>Services: <?php echo $row['Company_services']; ?></h3>
                <h3><img src="images/logo/<?php echo $row['Company_logo']; ?>" style="height:90px; width:160px;"></h3>
        </div>
    </div>    </div>
  ...
  <center>  <input id="btn-Preview-Image" type="button" value="Preview First Then Download"/>
    <a id="btn-Convert-Html2Image" href="#">Download</a>
     <a id="" href="design2.php?id=<?php echo  $_GET['id']; ?>">Next Design</a>
    <br/>
    <h3>Preview :</h3>
    <div id="previewImage">
    </div>
