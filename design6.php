...
<div id="html-content-holder" >
    <div class="front-side">
        ...
        <div class="info-grid" style="background-image:url(images/97e0e5abfef9ca9436d565613927c46c.jpg);">
            <div class="name">
...
<h5><?php echo $row['Company_contact_person_emailid']; ?></h5> 
    ...
    <div class="back-side"  
    style="background-image:url(images/97e0e5abfef9ca9436d565613927c46c.jpg);">
        <div class="color-grid">
            <div class="black"></div>
            <div class="red1"></div>
            <div class="red2"></div>
